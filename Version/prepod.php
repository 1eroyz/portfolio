...
$query4 = "SELECT * FROM prepod WHERE id_r = $iduser2";
...
$number = $_GET['number'];
if ($fio != "" and $number !="") {
	$update_query = "UPDATE prepod SET fio = '$fio', number = '$number' WHERE id_r = $iduser3";
	$update_result = mysqli_query ($link, $update_query);
}

header( "refresh:0;url = prepod.php" );
echo "";
}
...
<link rel="stylesheet" type="text/css" href="styler_prepod.css" >
...
<body>
	...
	<div class="content1">
		...
		<div class="buttons">
			<nav>Таблица "Преподователи"</nav><br>
		...
		<div class="formreg">
				<form method="get" class="ff4">
					<input type="text" style="display:none;" name="idst" value="<?php echo $edit_user['id_r'];?>">
					...
					<tr>
						...
						<td>
							...
							<?php if ($_SESSION['rights']=='p') { 
								...
								?>
								<a href="?iduser2=<?php echo $account['id_r']; ?>" ><img src="img/edit.svg" class="q2"></a>
							<?php } } ?>
							<?php if ($_SESSION['rights']!='p') { ?>
								<a href="?iduser2=<?php echo $account['id_r']; ?>" ><img src="img/edit.svg" class="q2"></a>
							<?php }  ?>
